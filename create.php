            ...
            <div class="card-body">
                ...
                <form action="./backend/create.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" id="inputnamaproduk" aria-describedby="emailHelp" placeholder="Contoh: Shampo " required>
                        <div id="emailHelp" class="form-text"></div>
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">Masukan Harga Produk</label>
                        <input type="number" name="price" placeholder="Contoh: 5000" class="form-control" id="harga" required>
                    </div>
                    <div class="mb-3">
